...
@section('title', 'Thêm Đợt thi Mới')
...
<div class="row g-5 g-xl-10">
    <!--begin::Col-->
    <div class="col-xl-12">
        <!--begin::Create Exam Form-->
        <div class="card card-flush">
            <!--begin::Card header-->
            <div class="card-header">
                <!--begin::Card title-->
                <div class="card-title">
                    <h2>Thêm Đợt thi Mới</h2>
                </div>
                <!--end::Card title-->
            </div>
            <!--end::Card header-->
            ...
            <div class="card-body pt-7">
                <form method="POST" action="{{ route('admin.exams.store') }}" class="form" id="exam-form">
                    @csrf
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8">
                            <textarea name="description" rows="3"
                                      ...
                                      placeholder="Nhập mô tả về đợt thi...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
